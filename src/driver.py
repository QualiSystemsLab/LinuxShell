...
class LinuxshellDriver (ResourceDriverInterface):
    ...
    def get_inventory(self, context):
        ...
        '''
        resource = Linuxshell.create_from_context(context)
    ...
    def _get_device_session(self, context):
        ...
        config = Linuxshell(name=context.resource.name).create_from_context(context)
    ...
    def send_command(self, context, commands):
        out = ''
        with self._get_device_session(context) as device_session:
            for command in commands.split(';'):
                out += device_session.send_command(command)
        return out
